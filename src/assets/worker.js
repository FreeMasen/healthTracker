...
var Database = /** @class */ (function (_super) {
    ...
    Database.prototype.isReady = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.seeds.orderBy('id').last()];
                    case 1:
                        lastUpdate = _a.sent();
                        return [2 /*return*/, lastUpdate.state === 'complete'];
                }
            });
        });
    };
    ...
    Database.prototype.getLatestUser = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.users.orderBy('id').last()];
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fetch(route).then(function (res) { return res.json(); })];
                    case 2:
                        seedData = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, this.batchSeed(table, seedData, updateCb)];
                    case 10:
                        _a.sent();
                        return [3 /*break*/, 12];
                    case 11:
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(start < batch.length - 1)) return [3 /*break*/, 6];
                        len = Math.min(10000, batch.length - start);
                        slice = batch.slice(start, start + len);
                        start += len;
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
