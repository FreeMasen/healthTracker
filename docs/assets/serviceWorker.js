...
(function (self) {
    ...
    function handleFetch(ev) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(ev.request).then(function (r) {
                        if (!r.ok) {
                            return fallbackResponse(ev.request).then(function (res) {
                                if (!res) {
                                    return r;
                                }
                                return res;
    ...
    function fallbackResponse(req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, self.caches.open('DnDCharacterManager')];
                    case 1:
                        cache = _a.sent();
